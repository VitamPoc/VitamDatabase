...
/**
 * Logger inspired from Netty implementation, adding some extra commands that allow to limit the
 * overhead of some ignored logger calls (toString or string construction is called only if
 * necessary).
 * 
 ...
 * 
 */
public abstract class WaarpInternalLogger implements WaarpInternalLoggerInterface {
